...
- His work improves reliability, incident response, deployment safety and cloud
  cost visibility.
- The next action is to read the CV, download the dossier/resume, or contact him.
...
- People arriving from `aminespired.fr`, GitHub, LinkedIn or legacy CV links.
...
- `/cv/` is readable as a long-form CV, not a dumped WordPress page.
